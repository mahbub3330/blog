                    ...
                    <div class="main-post">
                        ...
                        <div class="post-icons-area">
                            <ul class="post-icons">
                                <li>
                                    @guest
                                        <a href="javascript:void(0);" onclick="toastr.info('To add' +
                                                 'favorite list, You need to login first','Info',{
                                                    closeButton: true,
                                                    progressBar: true,
                                                 })"><i class="ion-heart"></i>
                        ...
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-info">
                                    ...
                                    <h4 class="title">
                                        <a href="{{ route('post.details',$randompost->slug) }}"><b>{{ $randompost->title }}</b></a>
                                    </h4>
                                            ...
                                            @guest
                                                <a href="javascript:void(0);" onclick="toastr.info('To add' +
                                                 'favorite list, You need to login first','Info',{
                                                    ...
                                                    {{ $randompost->favorite_to_user->count() }}</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="comment-form">
                        ...
                        @guest()
                                <p>For a new comment you must have to login first. <a href="{{ route('login') }}">Login</a></p>
                        @else
