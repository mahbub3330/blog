                    ...
                    <div class="body">
                        ...
                        <ul class="nav nav-tabs tab-nav-right" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="#change_with_password_icon_title" data-toggle="tab">
                        ...
                        <div class="tab-content">
                                ...
                                <form class="form-horizontal" method="post" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="email_address_2" class="form-control" placeholder="Enter your email address" name="email"
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="change_with_password_icon_title">
                                <form class="form-horizontal" method="post" action="{{ route('admin.password.update') }}" >
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="password" id="new_password" class="form-control" placeholder="Enter new password" name="password" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="password" id="confirm_password" class="form-control" placeholder="Enter New Password again" name="password_confirmation" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
